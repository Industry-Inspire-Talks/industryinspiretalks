                    ...
                    <div id="accordion">
                        <div class="car" style="padding-bottom:20px;">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" style=" border-bottom: 1px solid #e5e5e5;">
                                <div class="card-body mt-3" style="overflow:hidden;border-radius:1rem;font-style: normal;font-weight: normal;font-size: 20px;line-height: 28px;color: #000000;background: #EAF2FF;">
