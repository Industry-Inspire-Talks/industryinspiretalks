            ...
            <div class="row">
                <?php for ($i = 0; $i < 4; $i++) { ?>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card shadow" style="border-radius: 1rem;height:100%">
                            ...
                            <div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex">
                                        <input class="form-control p-1 mr-1" type="file" name="resume">
                                        <button name="" class="text-nowrap btn btn-success btn-sm"><i class="fa fa-paper-plane"></i> Send</button>
                                    </div>
